...
export default class FileInput {
    constructor(private _classSize: string, private _id: string, private _label: string, private _type: string = "file", private _name: string, private _accept: "image/png, image/jpeg", private _multiple = false) {
    }
