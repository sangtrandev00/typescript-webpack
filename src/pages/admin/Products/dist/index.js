...
var Products = /** @class */ (function (_super) {
    ...
    Products.prototype.submitHandler = function (e) {
        ...
        var typeForm = ProductForm.getAttribute('id');
        var shortDesc = this.shortDescEditor.getData;
        var fullDesc = this.fullDescEditor.getData;
        // Add/update category logic
        (function () { return __awaiter(_this, void 0, void 0, function () {
            var elements, images, name, stockQty, oldPrice, categoryId, discount, formData, i, response, oldImage, message, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    Products.prototype.getEditorData = function () {
        this.shortDescEditor = new Editor_1["default"]('#shortDescription');
        this.fullDescEditor = new Editor_1["default"]('#fullDescription');
    };
    Products.prototype.getEditorUpdateData = function () {
        this.updateShortDescEditor = new Editor_1["default"]('#update-product-form #shortDescription');
        this.updateFullDescEditor = new Editor_1["default"]('#update-product-form #fullDescription');
    };
    ...
    Products.prototype.editHandler = function () {
        ...
        (function () { return __awaiter(_this, void 0, void 0, function () {
            var response, product, name, discount, stockQty, oldPrice, categoryId, images, elements, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        ...
                        name = product.name, discount = product.discount, stockQty = product.stockQty, oldPrice = product.oldPrice, categoryId = product.categoryId, images = product.images;
