...
var Categories = /** @class */ (function (_super) {
    ...
    Categories.prototype.submitHandler = function (e) {
        ...
        (function () { return __awaiter(_this, void 0, void 0, function () {
            var elements, cateImage, name, description, formData, response, oldImage, message, error_2;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 6, , 7]);
                        response = void 0;
                        if (!(typeForm === "update-cate-form")) return [3 /*break*/, 3];
                    ...
                    case 2:
                        ...
                        response = _b.sent();
                        return [3 /*break*/, 5];
                    case 3: return [4 /*yield*/, categoriesApi_1["default"].add(formData)];
                    case 4:
                        // Add cate Call API
                        response = _b.sent();
                        _b.label = 5;
