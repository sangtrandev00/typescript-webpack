...
var Dashboard = /** @class */ (function (_super) {
    ...
    function Dashboard() {
        ...
        console.log(_this.myChartEl);
        console.log(_this.selectYearEl);
        _this.attach();
    ...
    Dashboard.prototype.calcTotalSales = function () {
        console.log(this.ordersSuccess);
        var totalSales = this.ordersSuccess.reduce(function (acc, order) { return acc + order.products.totalPrice + (order.vatFee || 0) + (order.shippingFee || 0); }, 0);
