...
var Checkout = /** @class */ (function (_super) {
    ...
    function Checkout() {
        ...
        _this.formValidator('order-form');
        _this.renderOrder();
        _this.attach();
        return _this;
    }
    ...
    Checkout.prototype.createOrder = function (e) {
        ...
        var formEl = e.target;
        (function () { return __awaiter(_this, void 0, void 0, function () {
            var currFormEles, inputSelectShippings, addressShipping, email, fullName, phone, note, paymentMethod, user, localCart, cart, products, promisesProducts, productsList, order, response, _id, error_1;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        promisesProducts = cart.cartList.map(function (cartItem) { return __awaiter(_this, void 0, void 0, function () {
                            var prodId, qty, productResponse, _a, name, oldPrice, discount, thumbnail, productItem, error_2;
    ...
    ;
    Checkout.prototype.formValidator = function (formId) {
