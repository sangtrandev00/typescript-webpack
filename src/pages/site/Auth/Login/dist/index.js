...
var Login = /** @class */ (function (_super) {
    ...
    function Login() {
        ...
        _this.formValidator('login-form');
        _this.attach();
        return _this;
    }
    ...
    Login.prototype.loginHandler = function (e) {
        ...
        var password = formEls["password"].value;
        var user = {
            email: email,
            password: password
        };
        ...
        (function () { return __awaiter(_this, void 0, void 0, function () {
            var authResponse, _a, token, userId, expiryDate, userAuth, error_1, errorType, errorMessage;
    ...
    Login.prototype.formValidator = function (formId) {
