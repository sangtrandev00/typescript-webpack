...
//                                 <!--Search button-->
//                                 <button id="search-btn" class="relative z-[2] flex items-center rounded-r bg-slate-600 px-6 py-2.5 text-xs font-medium uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-slate-600 hover:shadow-lg focus:bg-slate-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-slate-600-800 active:shadow-lg" type="button" data-te-ripple-init="" data-te-ripple-color="light">
