...
<div class="py-12">
    ...
    <h1 class="md:text-4xl text-2xl font-semibold px-4 leading-10 text-gray-800 dark:text-white   mt-6 text-center">What our client says</h1>
    <div class="container mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 xl:px-20 px-10 py-20 gap-6">
        <div>
            <div class="group w-full bg-white dark:bg-gray-800  relative flex flex-col items-center hover:bg-secondary-color cursor-pointer shadow-md md:p-12 p-6">
...
export default class Testimonial extends Component<HTMLDivElement> {
  constructor() {
    super('main');
